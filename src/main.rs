...
fn run_frame_handler(props: &GameProperties, frame_rx: channel::Receiver<libenc::EncodedFrame>) {
...
fn run_sound_handler(props: &GameProperties, frame_rx: channel::Receiver<libenc::EncodedFrame>) {
...
fn run_input_handler(props: &GameProperties, mut emu: (impl libemu::Emulator + Send + 'static)) {
...
fn main() {
    ...
    let mut emu = libemu::MameEmulator::create(props.resolution.w, props.resolution.h, props.fps);
